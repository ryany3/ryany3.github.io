...
function drawStats(i){
  ...
  text("SCORE: GUESSED " + numCorrect + " out of " + numDivs, 75, 2*topMargin + graphHeight + 40)
    ...
    alert("As you can see, many factors play into a stock's performance. Sometimes, it is completely unpredictable!")
